...
public class ConnectionDescriptorsTest {
    ...
    public void testConstruction() throws IOException {
        ...
        InstanceDescriptor instanceDescriptor1 = new InstanceDescriptor("dc", "rk", "ph", "ck", "cn", "sk", "sn", "rgk", "rgn", "ik", 1, "vn", "r", 0, true);
        InstanceDescriptor instanceDescriptor2 = new InstanceDescriptor("dc", "rk", "ph", "ck", "cn", "sk", "sn", "rgk", "rgn", "ik", 2, "vn", "r", 0, true);
